...
ROOT_URLCONF = 'xsolla_backend_2021.urls'
...
WSGI_APPLICATION = 'xsolla_backend_2021.wsgi.application'
...
DATABASES = {
    'default': {
        'ENGINE': 'djongo',
        "CLIENT": {
            "host": f"mongodb+srv://{mongo_user}:{mongo_password}@localhost:27017/?retryWrites=true&w=majority",
